...
- `layout.tsx` publishes root language and direction attributes, social and keyword metadata for MiniPay and PayLink request URLs, localized prefilled payment request URLs, payment proof, Celo explorer transaction links, shareable and reopenable receipt URLs, bilingual and localized payments, and MiniPay PWA discovery, plus mobile web app tags, referrer policy, and Talent App verification metadata.
