...
- `package.json` keywords highlight MiniPay public profiles, public profile URLs, PayLink localized payment request URLs and PayLink prefilled payment request URLs, payment proof, Celo receipts, Celo explorer transaction links, shareable and reopenable receipt URLs, no-custody settlement, walletless payment previews, bilingual and localized payments, and MiniPay PWA discovery.
