...
- `package.json` keywords highlight MiniPay public profiles, public profile URLs, payment request links, payment proof, Celo receipts, Celo explorer links, shareable and reopenable receipt URLs, no-custody settlement, walletless payment previews, bilingual and localized payments, and MiniPay PWA discovery.
