...
- `package.json` keywords highlight MiniPay public profiles, payment request links, Celo receipts, no-custody settlement, and walletless payment previews for repository discovery.
