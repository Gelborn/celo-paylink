...
Open the copied PayLink receipt URL in a signed-out browser once before sharing so reviewers see the same amount, token, reference, and handle without wallet state.
