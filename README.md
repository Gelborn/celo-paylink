...
- `layout.tsx` publishes root language and direction attributes, social and keyword metadata including payment proof, Celo explorer transaction links, and shareable and reopenable receipt URLs, mobile web app tags, referrer policy, and Talent App verification metadata.
