...
Create a public payment profile, add your handle, avatar, and preferred token, and receive stablecoin payments through public profile URLs like:
...
- `manifest.ts` publishes install metadata, maskable install icons, the `Manage PayLink public profile` shortcut, and English plus Brazilian Portuguese mobile demo screenshots.
