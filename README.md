...
- `robots.ts` and page metadata keep dashboard routes, PayLink receipt paths, and preview URLs out of indexing while PayLink receipt links still open directly for sharing.
