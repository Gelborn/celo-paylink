...
After a live payment, refresh the public profile once so reviewers can see the same amount, token, and reference in the newest recent PayLink contract event.
