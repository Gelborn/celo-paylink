...
- Share reopenable PayLink receipt URLs with a matching Celo explorer transaction link for the same transaction
...
- `package.json` keywords highlight MiniPay public profiles, public profile URLs, localized payment request links and localized prefilled payment request URLs, payment proof, Celo receipts, Celo explorer transaction links, shareable and reopenable receipt URLs, no-custody settlement, walletless payment previews, bilingual and localized payments, and MiniPay PWA discovery.
- `layout.tsx` publishes root language and direction attributes, social and keyword metadata for localized payment request links and localized prefilled payment request URLs, payment proof, Celo explorer transaction links, shareable and reopenable receipt URLs, bilingual and localized payments, and MiniPay PWA discovery, plus mobile web app tags, referrer policy, and Talent App verification metadata.
