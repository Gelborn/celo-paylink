...
- `SECURITY.md` asks private reports to include app surface, wallet prompt, PayLink URL type, receipt URL, and transaction context without secrets or unrelated wallet details.
