...
The GitHub Actions CI workflow is manual-only; trigger the manual workflow for the submitted commit after the final push if you need a hosted verification record.
