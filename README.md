...
- `layout.tsx` publishes root language and direction attributes, social and keyword metadata including payment proof, Celo explorer transaction links, shareable and reopenable receipt URLs, and installable PWA discovery, mobile web app tags, referrer policy, and Talent App verification metadata.
