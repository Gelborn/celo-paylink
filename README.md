...
Create a public payment profile, add your handle and avatar, and receive stablecoin payments through links like:
...
- Use MiniPay for the canonical mobile review before retesting the same profile link in other injected wallets.
...
- `sitemap.ts` publishes the canonical app origin for search engines; individual profile links are meant to be shared directly.
