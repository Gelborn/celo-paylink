...
9. Refresh the public profile after the success receipt page and show the newest recent payment from PayLink contract events on Celo with the same amount, token, and reference.
