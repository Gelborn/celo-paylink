...
- Install the PWA once and confirm the `Open PayLink dashboard` shortcut shows the `My PayLink` short label, describes public profile URL, localized prefilled payment request URLs, recent incoming payments, and reopening PayLink receipt URLs, and opens `/my`.
