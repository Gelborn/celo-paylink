...
- Install the PWA once and confirm the `Open PayLink dashboard` shortcut shows the `My PayLink` short label, describes profile management, payment request URLs, recent payments, and reopening receipt URLs, and opens `/my`.
