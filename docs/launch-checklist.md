...
- Install the PWA once and confirm the `Open PayLink dashboard` shortcut shows the `My PayLink` short label, describes public profile URL, request-link, incoming payment, and receipt management, and opens `/my`.
