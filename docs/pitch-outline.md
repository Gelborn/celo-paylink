...
- Reuse the same public profile or localized prefilled payment request links for repeat payments
...
- Copy a localized prefilled payment request link from the dashboard when a fixed amount is needed
...
- Minimal setup
- Localized prefilled payment request links
...
- Saved PayLink receipt links with matching Celo explorer transaction links for client bookkeeping
- Lightweight invoice templates that embed prefilled PayLink request URLs for repeat client requests
