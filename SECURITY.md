...
- whether a QR code was scanned, which device scanned it, and whether it encoded a public profile URL, localized PayLink prefilled payment request URL, or receipt URL
