...
- whether native sharing, clipboard copy, or a manually typed URL was involved, and whether it was a public profile URL, localized prefilled payment request URL, or receipt URL
- whether a QR code was scanned, which device scanned it, and whether it encoded a public profile URL, localized prefilled payment request URL, or receipt URL
...
- the amount, token, and reference query values, if a localized prefilled payment request URL is involved and they are safe to share
