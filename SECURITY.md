...
- whether native sharing, clipboard copy, or a manually typed URL was involved, and whether it was a public profile URL, request link, or receipt URL
- whether the URL was generated by PayLink or typed manually, if request parsing is involved
- the amount, token, and reference query values, if a request link is involved and they are safe to share
