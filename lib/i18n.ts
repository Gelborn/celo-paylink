...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    home: {
      ...
      proofChips: [
        ...
        "Amount, token, and reference stay in the request URL",
      ...
      stepsDescription:
        "Publish a profile, then use the same public profile or a prefilled payment request URL for each payment.",
      steps: [
        {
        ...
        },
        {
          ...
          description:
            "Share your public profile for open payments or create a prefilled payment request URL with amount, token, and reference."
        },
        {
    ...
    dashboard: {
      ...
      descriptionWithProfile:
        "Update profile details, create prefilled request URLs, and review incoming payments and receipt URLs.",
      ...
      quickActionTransactionsDescription:
        "Review incoming PayLink payments and open their matching receipt URLs.",
      profileShareHint:
      ...
      emptyTransactions:
        "Incoming payments and PayLink receipt URLs will appear here after someone pays through your public profile or payment request URL.",
      connectPrompt:
    ...
    messages: {
      ...
      profilePublished: "Profile published. Your public profile URL is ready to share.",
      ...
      copyingLink: "Copying this URL...",
      sharingLink: "Opening share options...",
      linkCopied: "URL copied. Ready to paste or share.",
      shareOpened: "Share options opened for this URL.",
      copyFailed: "Could not copy this URL on this device. Select the URL and copy it manually.",
  ...
  "pt-BR": {
    ...
    actions: {
      ...
      copyLink: "Copiar URL",
      copyProfile: "Copiar URL do perfil público",
      copyChargeLink: "Copiar URL de cobrança",
      shareLink: "Compartilhar URL",
      shareProfile: "Compartilhar perfil público",
      createChargeLink: "Criar URL de cobrança",
    ...
    home: {
      ...
      stepsDescription:
        "Publique um perfil e use o mesmo perfil público ou uma URL de cobrança preenchida para cada pagamento.",
      steps: [
        {
        ...
        },
        {
          ...
          description:
            "Compartilhe seu perfil público para pagamentos livres ou crie uma URL de cobrança preenchida com valor, token e referência."
        },
        {
    ...
    dashboard: {
      ...
      descriptionWithProfile:
        "Atualize os dados do perfil, crie URLs de cobrança preenchidas e acompanhe pagamentos recebidos e URLs de comprovante.",
      ...
      quickActionTransactionsDescription:
        "Revise os pagamentos PayLink recebidos e abra as URLs de comprovante correspondentes.",
      profileShareHint:
      ...
      emptyTransactions:
        "Os pagamentos recebidos e URLs de comprovante do PayLink aparecerão aqui depois que alguém pagar pelo seu perfil público ou URL de cobrança.",
      connectPrompt:
    ...
    messages: {
      ...
      profilePublished: "Perfil publicado. Sua URL do perfil público está pronta para compartilhar.",
      ...
      copyingLink: "Copiando esta URL...",
      sharingLink: "Abrindo opções de compartilhamento...",
      linkCopied: "URL copiada. Pronta para colar ou compartilhar.",
      shareOpened: "Opções de compartilhamento abertas para esta URL.",
      copyFailed: "Não foi possível copiar esta URL neste dispositivo. Selecione a URL e copie manualmente.",
