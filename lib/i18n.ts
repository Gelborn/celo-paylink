...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    success: {
      ...
      title: "Payment sent.",
      description:
        "Your transfer was submitted on Celo. Save the PayLink receipt as proof, then return to the profile for the latest activity.",
  ...
  "pt-BR": {
    ...
    success: {
      ...
      description:
        "Sua transferência foi enviada na Celo. Salve o comprovante do PayLink como confirmação e volte ao perfil para ver a atividade mais recente.",
