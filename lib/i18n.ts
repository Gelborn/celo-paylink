...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    home: {
      ...
      title: "A trusted profile link for direct Celo payments.",
      description:
      ...
      closingDescription:
        "Open the dashboard, create your profile, and share your profile link anywhere you get paid.",
      summaryTitle: "Your PayLink is live.",
      summaryDescription:
        "Share your profile, create prefilled request links, and review incoming payments from one dashboard.",
      connectHint:
    ...
    publicPage: {
      ...
      ownerDescription:
        "Visitors see the payment form here. Share it as-is, or open the dashboard to update details and create prefilled request links.",
  ...
  "pt-BR": {
    ...
    home: {
      ...
      title: "Um link de perfil confiável para pagamentos diretos na Celo.",
      description:
      ...
      closingDescription:
        "Abra o painel, crie seu perfil e compartilhe o link do seu perfil onde você recebe pagamentos.",
      summaryTitle: "Seu PayLink está no ar.",
      summaryDescription:
        "Compartilhe seu perfil, crie links de cobrança preenchidos e acompanhe pagamentos recebidos em um painel.",
      connectHint:
    ...
    publicPage: {
      ...
      ownerDescription:
        "Visitantes veem o formulário de pagamento aqui. Compartilhe como está ou abra o painel para atualizar dados e criar links de cobrança preenchidos.",
