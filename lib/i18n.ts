...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    dashboard: {
      ...
      quickActionChargeDescription:
        "Create a prefilled payment request link with amount, token, and reference.",
      quickActionTransactionsDescription:
        "Review incoming payments and open their matching PayLink receipt links.",
      profileShareHint:
        "Share this public profile wherever customers already reach you so they can pay or return to the same handle.",
      chargeLinkHint:
    ...
    success: {
      ...
      title: "Payment sent.",
      description:
        "Your transfer was submitted on Celo. Save the PayLink receipt link and matching Celo explorer transaction link as proof you can reopen later, then return to the public profile to see recent payment activity.",
    ...
    messages: {
      ...
      paymentComplete: "Payment complete. Your PayLink receipt link is ready.",
  ...
  "pt-BR": {
    ...
    dashboard: {
      ...
      quickActionChargeDescription:
        "Crie um link de cobrança PayLink preenchido com valor, token e referência.",
      quickActionTransactionsDescription:
        "Revise os pagamentos recebidos e abra os links de comprovante correspondentes do PayLink.",
      profileShareHint:
        "Compartilhe este perfil público onde seus clientes já falam com você para eles pagarem ou voltarem ao mesmo handle.",
      chargeLinkHint:
    ...
    success: {
      ...
      description:
        "Sua transferência foi enviada na Celo. Salve o link do comprovante do PayLink e o link da transação correspondente no explorer da Celo como prova que você pode reabrir depois; em seguida, volte ao perfil público para ver os pagamentos recentes.",
    ...
    messages: {
      ...
      paymentComplete: "Pagamento concluído. Seu link de comprovante do PayLink está pronto.",
