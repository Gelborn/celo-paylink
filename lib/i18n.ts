...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    publicPage: {
      ...
      noContractTitle: "PayLink is not ready on this network.",
    ...
    success: {
      ...
      title: "Payment sent.",
      description:
        "Your transfer was submitted on Celo. Save the PayLink receipt and matching explorer link as proof, then return to the profile to see recent payment activity.",
  ...
  "pt-BR": {
    ...
    publicPage: {
      ...
      noContractTitle: "PayLink não está pronto nesta rede.",
      noContractDescription:
    ...
    success: {
      ...
      description:
        "Sua transferência foi enviada na Celo. Salve o comprovante do PayLink e o link correspondente do explorer como prova, depois volte ao perfil para ver os pagamentos recentes.",
