  ...
  return (
    <motion.button
      ...
      className={clsx(
        ...
        variant === "primary" &&
          "border-[color:var(--accent)] bg-[color:var(--accent)] text-zinc-950 shadow-[0_10px_24px_rgba(57,217,138,0.1)] hover:border-[color:var(--accent-strong)] hover:bg-[color:var(--accent-strong)] hover:shadow-[0_14px_32px_rgba(57,217,138,0.14)]",
        variant === "secondary" &&
          "border-white/10 bg-white/[0.065] text-zinc-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] hover:border-white/20 hover:bg-white/[0.095]",
        variant === "outline" &&
          "border-white/15 bg-zinc-950/20 text-zinc-100 hover:border-white/25 hover:bg-white/[0.06]",
        variant === "ghost" &&
