...
export const metadata: Metadata = {
  ...
  description:
    "Manage your MiniPay PayLink public profile, create localized prefilled payment request links, review recent incoming payments, and reopen PayLink receipt URLs.",
  alternates: {
    canonical: "/my"
  },
  robots: {
