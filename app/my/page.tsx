...
export const metadata: Metadata = {
  ...
  description:
    "Manage your MiniPay PayLink public profile, create prefilled payment request links, review recent incoming payments, and reopen shareable PayLink receipts.",
  alternates: {
    canonical: "/my"
  },
  robots: {
