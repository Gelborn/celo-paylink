...
export const metadata: Metadata = {
  ...
  description:
    "Create a MiniPay PayLink public payment profile, share localized prefilled payment request URLs, and receive direct no-custody Celo stablecoin payments in your wallet with shareable, reopenable PayLink receipt URLs.",
  ...
  keywords: [
    ...
    "PayLink localized payment request URLs",
    "walletless payment previews",
    "bilingual payments",
    "localized payments",
    "Celo stablecoin payment request URLs",
    "payment receipts",
    "payment proof",
    "Celo receipts",
  ...
  openGraph: {
    title: "MiniPay PayLink",
    description:
      "Publish a no-custody public payment profile, share localized prefilled payment request URLs, and give payers shareable, reopenable PayLink receipt URLs after direct no-custody Celo stablecoin payments.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "MiniPay PayLink public profile URL payment page and shareable, reopenable receipt preview"
      }
    ]
  },
  twitter: {
