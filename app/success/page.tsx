...
const receiptDescription =
  "Open a shareable PayLink receipt with the amount, token, reference, recipient handle, matching Celo explorer transaction proof for the same transaction hash, and a path back to the recipient profile.";
