...
const receiptTitle = "Shareable, reopenable MiniPay PayLink receipt URL";
const receiptDescription =
  "Open a shareable, reopenable PayLink receipt URL with the amount, token, reference, recipient handle, a matching Celo explorer transaction link for the same transaction hash, and a path back to the recipient profile.";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "MiniPay PayLink shareable, reopenable receipt with matching Celo explorer transaction link preview"
        }
      ]
    },
    twitter: {
