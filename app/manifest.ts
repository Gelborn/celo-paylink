...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    dir: "ltr",
    description:
      "A MiniPay-ready public payment profile for direct no-custody Celo stablecoin payments, localized PayLink prefilled payment request URLs, and shareable, reopenable PayLink receipt URLs.",
    ...
    shortcuts: [
      {
        ...
        description: "Open the PayLink dashboard to manage your public profile URL, create localized PayLink prefilled payment request URLs, review recent PayLink event payments, and reopen PayLink receipt URLs.",
        url: "/my",
        icons: [
          {
            src: "/icon.svg",
