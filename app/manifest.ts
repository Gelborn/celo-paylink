...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    dir: "ltr",
    description:
      "A MiniPay-ready profile for direct no-custody Celo stablecoin payments, localized PayLink prefilled payment request URLs, and shareable, reopenable PayLink receipt URLs.",
