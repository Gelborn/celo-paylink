...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    dir: "ltr",
    description:
      "A MiniPay-ready public payment profile for localized no-custody Celo stablecoin payments, localized prefilled payment request links, and shareable, reopenable PayLink receipt URLs.",
    ...
    shortcuts: [
      {
        ...
        description: "Open the PayLink dashboard to manage your public profile URL, create localized prefilled payment request links, review recent incoming payments, and reopen PayLink receipt URLs.",
        url: "/my",
        icons: [
          {
            src: "/icon.svg",
