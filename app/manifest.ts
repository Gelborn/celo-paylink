...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    dir: "ltr",
    description:
      "A MiniPay-ready public payment profile for localized no-custody Celo stablecoin payments, prefilled payment request links, and shareable, reopenable PayLink receipt URLs.",
